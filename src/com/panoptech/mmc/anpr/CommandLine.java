...
public class CommandLine
{
   ...
   //
   private Set<String> _flagsWithValues = new HashSet<String>();
   
   // Devon...
   public Set<String> getFlagNames()
   {
	   return _flagsWithValues;
   }
   ...
   {
       List<String> regularArgs = new ArrayList<String>();
       ...
       _arguments = regularArgs.toArray(new String[size]);
   }
